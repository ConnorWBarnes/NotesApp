...
public abstract class WritableKeyedRepository<TEntity, TPrimaryKey> : WritableRepository<TEntity>, IWritableKeyedRepository<TEntity, TPrimaryKey> 
    where TEntity : class, IKeyedEntity<TPrimaryKey>
{
    protected WritableKeyedRepository(ILogger logger, ISqlContext context)
        : base(logger, context)
    {
    }
...
public abstract class WritableKeyedRepository<TEntity, TPrimaryKey, TSpecification> : WritableRepository<TEntity, TSpecification>, IWritableKeyedRepository<TEntity, TPrimaryKey, TSpecification>
    where TEntity : class, IKeyedEntity<TPrimaryKey>
    where TSpecification : IKeyedSpecification<TSpecification, TEntity, TPrimaryKey>
{
    protected WritableKeyedRepository(ILogger logger, ISqlContext context, ISpecificationFactory specificationFactory)
