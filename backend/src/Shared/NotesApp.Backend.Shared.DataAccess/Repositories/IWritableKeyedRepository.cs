...
public interface IWritableKeyedRepository<TEntity, TPrimaryKey, out TSpecification> : IReadableKeyedRepository<TEntity, TPrimaryKey, TSpecification>, IWritableRepository<TEntity, TSpecification>
    where TEntity : class, IKeyedEntity<TPrimaryKey>
